...
namespace Capinfo.Migrations
{
    ...
    [Migration("20200721082931_AddAuthorityRoles")]
    partial class AddAuthorityRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Capinfo.Authorization.Authoritys.Authority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Capinfo.Authorization.Authoritys.AuthorityRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Capinfo.His.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("COMPANY_POST")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Capinfo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Capinfo.Authorization.Users.User", null)
                        .WithMany("Claims")
